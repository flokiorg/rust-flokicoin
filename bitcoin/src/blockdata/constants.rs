...
pub const PUBKEY_ADDRESS_PREFIX_MAIN: u8 = 35; // 0x23
...
pub const SUBSIDY_HALVING_INTERVAL: u32 = 265_000;
/// Maximum allowed value for an integer in Script.
pub const MAX_SCRIPTNUM_VALUE: u32 = 0x80000000; // 2^31
/// Number of blocks needed for an output from a coinbase transaction to be spendable.
pub const COINBASE_MATURITY: u32 = 300;
...
fn bitcoin_genesis_tx(params: &Params) -> Transaction {
    // Base
    let mut ret: Transaction = Transaction {
    ...
    let (in_script, out_script) = {
        match params.network {
            Network::Testnet4 => (
                ...
                .push_slice(b"Twitter 12/Sep/2021 Floki has arrived")
                .into_script(),
    ...
    ret.output.push(TxOut { value: Amount::from_sat(1000 * 100_000_000), script_pubkey: out_script });
    ...
    match params.network {
        Network::Bitcoin => Block {
            header: block::Header {
                ...
                merkle_root,
                time: 1631485359,
                bits: CompactTarget::from_consensus(0x1e56b940),
                nonce: 2083390567,
            },
            txdata,
        },
